...
def test_next_plan_for_feature_returns_upgrade_target() -> None:
    ...
    upgrade_for_growth_autopilot = next_plan_for_feature("growth", "autopilot_queue")
